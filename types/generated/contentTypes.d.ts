...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Project client / customer';
    displayName: 'Client';
    pluralName: 'clients';
    singularName: 'client';
  };
...
export interface ApiEmployeeEmployee extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    daily_capacity: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          max: 24;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Capacity planning project';
    displayName: 'Project';
    pluralName: 'projects';
  ...
  attributes: {
    assigned_employees: Schema.Attribute.Relation<
      'manyToMany',
      'api::employee.employee'
    >;
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    required_skills: Schema.Attribute.Relation<
      'manyToMany',
      'api::skill.skill'
    >;
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    status: Schema.Attribute.Enumeration<['active', 'inactive']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'active'>;
    team_leader: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    updatedAt: Schema.Attribute.DateTime;
